...
| Indicator LED          | 5 mm **diffused RGB** (common cathode/anode)       | 1   | Jaycar / Core       | $1–$3          | Mirrors UI state (G/A/R) |
| Resistors              | **220–330 Ω** (per LED channel)                    | 3   | Jaycar              | <$1            | Current limiting (R/G/B) |
...
LED: R→GPIO13, G→GPIO12, B→GPIO14 (each through 220–330 Ω).  
...
- **Decision:** pick the **worst** of the two signals.  
...
- **Core Electronics** / PiicoDev — ESP32 boards, ENS160, TMP117, QT cables, LiPo.  
- **Jaycar** — LEDs, resistors, slide switch, wire, heat-shrink.  
